...
.ajaxLoader {
    ...
    <body>
    	...
    	<table style="width: 100%; height:100%;">
    		<tr>
    			<td id="leftColumn">
    				<?php include 'widgets/user_profile_widget.php'; ?>
    				<br/>
    				<?php include 'widgets/attribute_list_widget.php'; ?>
    			</td>
    			<td id="firstRight">
    				<table style="width: 100%; height: 100%">
    					<tr>
    						<td id="upperRight">
    							<table style="width: 100%; height: 100%">
	    							<tr>
	    								<td id="center"><?php include 'widgets/rec_visualization_widget.php'; ?></td>
	    								<td id="rightColumn"><?php include 'widgets/movie_profile_widget.php'; ?></td>
	    							</tr>
    							</table>
    						</td>
    					</tr>
    					<tr>
    						<td id="footer"><?php include 'widgets/user_movies_widget.php'; ?></td>
    					</tr>
    				</table>
    			</td>
    		</tr>
